...
const OffersForRequest = ({
  ...
  return <div className="space-y-4">
      ...
      <div className="space-y-3">
        {offers.map(offer => <OfferCard key={offer.id} offer={offer} showActions={true} onStatusUpdate={handleOfferUpdate} currentUserId={user?.id} buyRequestOwnerId={buyRequestOwnerId} />)}
      </div>
    </div>;
};
