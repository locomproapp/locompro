...
export const PriceInput = ({
  ...
  return <FormItem>
      ...
      <Input type="text" inputMode="numeric" value={displayValue} onChange={e => handlePriceChange(e.target.value)} placeholder="$0" className={error ? 'border-destructive focus-visible:ring-destructive' : ''} />
