...
const SearchSection = ({ searchQuery, onInputChange, onSubmit }: SearchSectionProps) => {
  return (
    <>
      <div className="mb-4 sm:mb-10 mt-6 sm:mt-32 flex justify-center">
      ...
      <div className="flex flex-row gap-2 sm:gap-4 justify-center mb-4 mt-6 sm:mt-24 px-0 sm:px-2">
