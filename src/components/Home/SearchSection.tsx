...
const SearchSection = ({ searchQuery, onInputChange, onSubmit }: SearchSectionProps) => {
  return (
    <>
      <div className="mb-6 sm:mb-10 mt-10 sm:mt-12 flex justify-center">
      ...
      <div className="flex flex-row gap-2 sm:gap-4 justify-center mb-4 mt-10 sm:mt-12 px-0 sm:px-2">
