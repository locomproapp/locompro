...
const SearchSection = ({ searchQuery, onInputChange, onSubmit }: SearchSectionProps) => {
  return (
    <>
      <div className="mb-10 sm:mb-10 flex justify-center">
      ...
      <div className="flex flex-row gap-2 sm:gap-4 justify-center mb-10 sm:mb-12 px-0 sm:px-2">
        <Button asChild size="sm" className="text-base sm:text-lg px-4 py-6 sm:px-8 sm:py-6 flex-1 sm:flex-none max-w-[140px] sm:max-w-none">
          <Link to="/marketplace">
