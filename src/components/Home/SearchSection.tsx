...
const SearchSection = ({ searchQuery, onInputChange, onSubmit }: SearchSectionProps) => {
  return (
    <>
      ...
      <div className="flex flex-row gap-2 sm:gap-4 justify-center mb-8 sm:mb-12 w-full max-w-2xl mx-auto">
        <Button asChild size="sm" className="text-base sm:text-lg px-8 py-6 sm:px-8 sm:py-6 flex-1 sm:flex-none">
          <Link to="/marketplace">
