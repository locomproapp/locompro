...
const HeroSection = () => {
  return (
    <div className="text-center mb-6 sm:mb-16 mt-4 sm:mt-12">
      ...
      {/* Desktop subheader */}
      <p className="text-xl text-muted-foreground mb-4 sm:mb-6 mt-6 sm:mt-6 max-w-3xl mx-auto hidden sm:block">
