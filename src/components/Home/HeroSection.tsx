...
const HeroSection = () => {
  return (
    <div className="text-center mb-6 sm:mb-16 mt-4 sm:mt-8">
      ...
      {/* Desktop subheader */}
      <p className="text-xl text-muted-foreground mb-4 sm:mb-8 mt-6 sm:mt-11 max-w-3xl mx-auto hidden sm:block">
