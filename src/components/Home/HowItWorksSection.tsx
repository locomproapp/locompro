    ...
    <div className="block md:hidden">
      <Collapsible open={isOpen} onOpenChange={handleToggle}>
        <CollapsibleTrigger asChild>
          <div className="bg-white rounded-lg shadow-sm border border-border p-4 cursor-pointer hover:shadow-md transition-shadow">
        ...
        <CollapsibleContent ref={howItWorksRef}>
          <div className="bg-white rounded-lg shadow-sm border border-border overflow-hidden mt-2">
            <div className="p-4">
